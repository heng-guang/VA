...
description: |
  In this exercise, I learnt how to edit a web article by using Distill for R Markdown
author:
  - name: Sia Heng Guang
...
+ To reveal the relationship between high dimensional variables pairwisely.
...
* to create a new RMarkdown document
