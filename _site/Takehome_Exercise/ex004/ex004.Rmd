...
A popular heatmap for visualising stock prices is [*Finviz*](https://finviz.com/map.ashx). From there, we can toggle the performance time interval from one day until one year. 

From observations, the "**6 Months Performance**" is using a scale from -24% to +24% in intervals of 8%, while the "**1 Year Performance**" is using a scale from -30% to +30% in intervals of 10%. Hence, I decided to use a scale of **-36% to +36%** in intervals of 12% for a dataset of **two years**.
